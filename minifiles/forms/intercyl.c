...
double				test_soluce(t_cylindre cyl, t_ray r, double x[3], t_point so)
{
	t_point stoi;
	double size[2];
	double ori;
...
double				solve_tube(t_cylindre cyl, t_ray r, t_point *norm)
{
	double x[3];
	double abc[4];
	t_point u;
...
double				solve_circle(t_circle c, t_ray r)
{
	double	ori;
	double	ir;
	t_point imp;
